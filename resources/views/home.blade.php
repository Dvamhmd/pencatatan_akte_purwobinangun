...
<div class="space-y-6">
    ...
    <!-- Header Section Bertema Kalurahan Purwobinangun -->
    <div class="bg-white rounded-xl shadow-xs border border-slate-200 overflow-hidden">
        ...
        <div class="p-5 md:p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="bg-white border-2 border-teal-100 hover:border-[#059cb8] rounded-xl overflow-hidden shadow-xs civic-card flex flex-col justify-between">
                <div>
                    <!-- Header Kartu -->
            ...
            <div class="bg-white border-2 border-rose-100 hover:border-rose-500 rounded-xl overflow-hidden shadow-xs civic-card flex flex-col justify-between">
                <div>
                    <!-- Header Kartu -->
    ...
    <!-- Quick Tracker Box -->
    <div class="bg-gradient-to-r from-[#095b8c] via-[#059cb8] to-[#3887c2] rounded-xl p-5 text-white shadow-sm flex flex-col md:flex-row items-center justify-between gap-4">
    ...
    <div class="bg-white rounded-xl shadow-xs border border-slate-200 p-5 md:p-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div class="p-4 rounded-xl bg-slate-50 border border-slate-200/70 text-center relative">
